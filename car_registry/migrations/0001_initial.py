# Generated by Django 3.1.4 on 2020-12-09 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('make', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='car_registry.carmake')),
            ],
            options={
                'db_table': 'models',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exterior_color', models.CharField(blank=True, max_length=255, null=True)),
                ('make', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='car_registry.carmake')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='car_registry.carmodel')),
                ('submodel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='car_registry.carsubmodel')),
            ],
            options={
                'abstract': False,
            },
